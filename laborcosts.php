...
<body>
		...
		<div class="container-fluid-full">
			<div class="row-fluid">
				...
				<div id="content" class="span10">
					<? require_once("views/laborcosts.php");?>
				</div>
				<!-- end: Content -->
	...
	<script type="text/javascript">
		function deleteLaborCost(laborid){
			if(confirm("Are you sure you want to delete this Labor Cost?")){
				window.location="laborcosts.php?delete=1&id="+laborid;
			}else{
				return false;
			}
		}
