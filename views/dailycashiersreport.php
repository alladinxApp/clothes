<div class="row-fluid">		
	<div class="box span12">
		<div class="box-header" data-original-title>
			<h2><i class="icon-money"></i><span class="break"></span><b>Daily Cashiers Report</b></h2>
		</div>
			...
			<form class="form-horizontal">
				<fieldset>
					<div class="control-group">
						...
						<div class="controls">
							<input class="input-xlarge datepicker" name="txtDate" id="txtDate" value="<?=date('m/d/Y')?>" readonly type="text" placeholder="Date: MM/DD/YYYY" />
						</div>
					</div>
					<div class="control-group">
...
<div class="row-fluid">		
	<div class="box span12">
		<form method="Post" action="export.php" target="_blank">
			...
			<input type="hidden" name="Type" id="Type" value="dailycashiersreport" />
