<div class="row-fluid">		
	<div class="box span12">
		<div class="box-header" data-original-title>
			<h2><i class="icon-shopping-cart"></i><span class="break"></span><b>Pending Job Orders Report</b></h2>
		</div>
		<div class="body-content" style="padding: 20px;">
			<form class="form-horizontal">
				<fieldset>
					...
					<div class="control-group">
						<label class="control-label" for="txtJobTypeDescription">Job Type</label>
						<div class="controls">
						<input class="input-xlarge" name="txtJobTypeDesc" readonly id="txtJobTypeDesc" type="text" placeholder="Job Type Here..." />
						</div>
					</div>
				...
				<input type="hidden" name="txtJobType" id="txtJobType" value="" />
			</form>
		</div>
...
<div class="row-fluid">		
	<div class="box span12">
		...
		<input type="submit" name="btnExport" id="btnExport" class="btn btn-primary" value=" EXPORT " />
			...
			<input type="hidden" name="Type" id="Type" value="pendingjobordersreport" />
