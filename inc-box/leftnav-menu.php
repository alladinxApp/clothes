	...
	<div class="nav-collapse sidebar-nav">
		<ul class="nav nav-tabs nav-stacked main-menu">
			...
			<li>
				...
				<ul>
					<li><a class="submenu" href="controlnos.php"><i class="icon-cogs"></i> <span class="hidden-tablet">Control Nos</span></a></li>
			...
			<li>
				...
				<ul>
					<li><a class="submenu" href="#"><i class="icon-briefcase"></i> <span class="hidden-tablet">Estimates</span></a></li>
				</ul>	
			</li>
			<li>
				<a class="dropmenu" href="#"><i class="icon-folder-close"></i> <span class="hidden-tablet">Reports</span></a>
				<ul>
					<li><a class="submenu" href="#"><i class="icon-calendar"></i> <span class="hidden-tablet">Report 1</span></a></li>
				</ul>	
			</li>
		</ul>
	</div>
