<?
	...
	require_once(CONTROLLER_PATH . USERPROFILECONTROLLER);
?>
...
<script type="text/javascript">
	$(document).ready(function() {
		chkOldPassword = function(u,p){
			$.ajax({
				url: 'inc-ajax/divChkOldPassword.php?u='+u+'&p='+p,
				type: 'GET',
				data: null,
				datatype: 'json',
				...
				success: function (data) {
					$("#divOldPassword").replaceWith(data);
				},	
		...
		chkNewPassword = function(){
			var n = $("#txtNewPassword").val();
			var c = $("#txtConPassword").val();

			$.ajax({
				url: 'inc-ajax/divChkNewPassword.php?n='+n+'&c='+c,
				type: 'GET',
				data: null,
				datatype: 'json',
				contentType: 'application/json; charset=utf-8',
				...
				success: function (data) {
					$("#divNewPassword").replaceWith(data);
				},	
